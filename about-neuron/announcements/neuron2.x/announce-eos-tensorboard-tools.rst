...
To begin using Neuron Explorer (available since Neuron 2.27) for profiling, see `the Neuron Explorer documentation </tools/neuron-explorer/index>`. Neuron Explorer was introduced with :doc:`the release of the AWS Neuron SDK version 2.27.0 </release-notes/2.27.0/index>`.