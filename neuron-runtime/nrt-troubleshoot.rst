...
+-------------------------------------+-----------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| HBM Repairable Uncorrectable        | An HBM encountered an repairable uncorrectable error      | Neuron Runtime Behavior:                                                                                                      | 1. Reload the neuron driver or `stopping then starting <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Stop_Start.html>`_ the EC2 instance.                     |
|                                     | and produced incorrect results.                           | Neuron Runtime will timeout and exit with ``NRT_TIMEOUT (5)``                                                                 |                                                                                                                                                                      |
|                                     |                                                           | or ``NRT_EXEC_HW_ERR_REPAIRABLE_HBM_UE (1205)`` return code.                                                                  | 2. Utilize `Neuron Sysfs <https://awsdocs-neuron.readthedocs-hosted.com/en/latest/tools/neuron-sys-tools/neuron-sysfs-user-guide.html#description-for-each-metric>`_ |
|                                     |                                                           | You will see the following error message in runtime logs from stdout console: ``(FATAL-RT-UNDEFINED-STATE)                    | and `Neuron Monitor <https://awsdocs-neuron.readthedocs-hosted.com/en/latest/tools/neuron-sys-tools/neuron-monitor-user-guide.html#system-level-metric-groups>`_     |
|                                     |                                                           | Uncorrectable HBM memory error is detected. Execution results may be invalid.                                                 | to monitor the ``mem_ecc_repairable_uncorrected`` error counts.                                                                                                      |
|                                     |                                                           | Please reload the neuron driver or reboot your EC2 instance to prevent future impact from the hardware error.``               |                                                                                                                                                                      |
+-------------------------------------+-----------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------+
