.. _neuron-2-XX-X-dlami:

.. meta::
   :description: The official release notes for the AWS Neuron SDK Deep Learning AWS Machine Images (DLAMIs) component, version X.XX.0. Release date: XX/XX/2025.
...
* Go back to the :ref:`AWS Neuron 2.XX.X release notes home <neuron-2-XX-X-whatsnew>`
