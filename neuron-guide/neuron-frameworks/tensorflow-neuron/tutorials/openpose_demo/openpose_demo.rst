...
In this tutorial we will compile and deploy OpenPose model on an Inf1 instance. To enable faster enviroment setup, you will run the tutorial on an inf1.6xlarge instance to enable both compilation and deployment (inference) on the same instance.
...
* :ref:`OpenPose Environment Setup`  - Steps needed to setup the compilation and deployment enviroments that will enable you to run this tutorial. In this tutorial a single inf1 instance will provide both the compilation and deployment enviroments.

 If you already have Inf1 environment ready, you can skip to :ref:`OpenPose Running the tutorial`.

* :ref:`OpenPose Running the tutorial` - The tutorial is available as a Jupyter notebook. You have the option to run the tutorial as a Jupyter notebook or run the tutorial on the EC2 instance terminal as a script. This section will guide you into the two options. 
* :ref:`openpose-cleanup-instances` - After running the tutorial, make sure to cleanup instance/s used for this tutorial.

.. _OpenPose Environment Setup:
...
.. _OpenPose Running the tutorial:
