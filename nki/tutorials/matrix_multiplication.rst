...
to improve DMA efficiency.  This is done by arranging an array of blocks, such
that the partition dimension in the `nl.ndarray` that allocates them remains
aligned with the first dimension.
