...
troubleshoot performance issues on NeuronDevices using :doc:`Neuron Explorer </nki/how-to-guides/use-neuron-profile>`,
a profiler tool designed specifically for NeuronDevices. This guide is also written assuming readers have read
through :doc:`NKI Programming Model </nki/deep-dives/programming_model>` and familiarized themselves with key NKI concepts.
...
a detailed instruction execution trace on device using :doc:`neuron-profiler </nki/how-to-guides/neuron_profile_for_nki>`.
...
As discussed in :doc:`NKI Programming Model </nki/deep-dives/programming_model>`,
...
:doc:`NKI Performance Guide </nki/how-to-guides/nki_perf_guide>` for more information
