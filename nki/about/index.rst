.. meta::
   :description: Learn about the Neuron Kernel Interface (NKI) and core concepts essential for working with it.
...
* :doc:`Trainium/Inferentia2 Architecture Guide </nki/about/trainium_inferentia2_arch>` serves as a foundational architecture guide for understanding the basics of any NeuronDevice generation.
* :doc:`Trainium2 Architecture Guide </nki/about/trainium2_arch>` walks through the architecture enhancements when compared to the previous generation.
* :doc:`Trainium3 Architecture Guide </nki/about/trainium3_arch>` covers the enhancements for the next-generation Trainium ML accelerators.
  
Neuron recommends new NKI developers start with :doc:`Trainium/Inferentia2 Architecture Guide <trainium_inferentia2_arch>` before exploring newer NeuronDevice architecture.
...
For more information, see :doc:`the NKI Compiler documentation </nki/compiler/index>`.
...
For a more in-depth example of profiling a NKI kernel with Neuron Explorer, see :doc:`/nki/how-to-guides/use-neuron-profile` and the :doc:`Neuron Explorer documentation </tools/neuron-explorer/index>`.
...
For a deep dive into the NKI Language, see :doc:`/nki/deep-dives/nki-language-guide`. Otherwise, read up on the core programming concepts below!
...
For more details on programming with NKI, see :doc:`/nki/deep-dives/programming_model`.
...
.. toctree::
      ...
      Trainium/Inferentia2 Architecture <trainium_inferentia2_arch>
      Trainium2 Architecture <trainium2_arch>
      Trainium3 Architecture <trainium3_arch>
      NKI Beta Features <nki-beta-versions>
      Known Issues <nki_known_issues>
      FAQ <nki_faq>
