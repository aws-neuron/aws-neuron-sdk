...
.. important::
   This topic applies to NKI in versions 2.26.1 or earlier of the AWS Neuron SDK, and is provided as a legacy document for users who are on those earlier versions. 
   
   For more up-to-date guidance that covers this material, see:

   * :doc:`/nki/get-started/setup-env`
   * :doc:`/nki/get-started/quickstart-implement-run-kernel`

In this guide, we will implement a simple "Hello World" style NKI kernel and run it on a NeuronDevice
(Trainium/Inferentia2 or beyond device). We will showcase how to invoke a NKI kernel standalone through NKI baremetal mode
...
.. nki_example:: /nki/examples/getting_started_baremetal.py
   :language: python
   :linenos:
...
.. nki_example:: /nki/examples/getting_started_torch.py
   :language: python
   :linenos:
...
.. nki_example:: /nki/examples/getting_started_jax.py
   :language: python
   :linenos:
...
- NKI baremetal script: :download:`getting_started_baremetal.py </nki/examples/getting_started_baremetal.py>`
- PyTorch script: :download:`getting_started_torch.py </nki/examples/getting_started_torch.py>`
- JAX script: :download:`getting_started_jax.py </nki/examples/getting_started_jax.py>`