...
**Source code for this kernel API can be found at**: `ssd.py <https://github.com/aws-neuron/nki-library/blob/2.32/src/nkilib_src/nkilib/experimental/scan/ssd.py>`_
