...
**Source code for this kernel API can be found at**: `blockwise_mm_backward_mxfp8.py <https://github.com/aws-neuron/nki-library/blob/2.32/src/nkilib_src/nkilib/experimental/moe_mxfp8/bwd/blockwise_mm_backward_mxfp8.py>`_
