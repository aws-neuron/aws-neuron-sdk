...
**Source code for this kernel API can be found at**: `ring_attention_bwd.py <https://github.com/aws-neuron/nki-library/blob/2.32/src/nkilib_src/nkilib/experimental/attention/ring_attention_bwd.py>`_
