...
This topic covers the usage of the Neuron Profiler (neuron-profile) for profiling the performance of NKI kernels. The version of neuron-profile covered here will be considered legacy software following the full release of the new Neuron profiler.

.. note::
   AWS Neuron is releasing a new version of the Neuron Profiler in December 2025. For documentation on how to use it, see :doc:`use-neuron-profile`.
...
.. literalinclude:: /nki/examples/prof-kernel.py
   :language: python
   :linenos:
...
.. literalinclude:: /nki/examples/prof-kernel-profile.py
   :language: python
   :linenos:
...
.. figure:: /nki/img/neuron-profile-ui-overview.png
   :align: center
...
.. figure:: /nki/img/neuron-profile-instruction-hover.png
   :align: center
   :class: outlined-image
...
.. figure:: /nki/img/neuron-profile-instruction-details.png
   :align: center
   :class: outlined-image
   :width: 500
...
.. figure:: /nki/img/neuron-profile-search-help.png
   :align: center
   :class: outlined-image
   :width: 500
...
.. figure:: /nki/img/neuron-profile-search-results.png
   :align: center
   :class: outlined-image
...
.. figure:: /nki/img/neuron-profile-box-select-help.png
   :align: center
   :width: 500
...
.. figure:: /nki/img/neuron-profile-box-select-results.png
   :align: center
   :class: outlined-image
...
.. figure:: /nki/img/neuron-profile-source-code-view.png
   :align: center
