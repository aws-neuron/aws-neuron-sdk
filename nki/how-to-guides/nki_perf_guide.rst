...
to address such bottlenecks. During this process, we will showcase how to leverage :doc:`neuron-profile </nki/how-to-guides/neuron_profile_for_nki>`,
...
with this document, make sure to read through :doc:`NeuronDevice Architecture Guide </nki/about/trainium_inferentia2_arch>`
...
:doc:`Matmul NKI Tutorial Optimization 1-3 </nki/tutorials/matrix_multiplication>` for more
...
:doc:`Fused Attention Tutorial </nki/tutorials/fused-self-attn>` for more detailed discussion.
...
See :doc:`Fused Self Attention </nki/tutorials/fused-self-attn>` tutorial for more detailed discussion.
...
in the :doc:`architecture guide </nki/about/trainium_inferentia2_arch>`, NeuronCore compute engines
...
walking through the :doc:`architecture guide </nki/about/trainium_inferentia2_arch>` in detail to better understand capabilities of
...
See the :doc:`Mamba tutorial </nki/tutorials/fused_mamba>` for more discussion.
...
:doc:`architecture guide </nki/about/trainium_inferentia2_arch>` to learn what operations can be done in a pipeline fashion
...
See :doc:`Fused Mamba </nki/tutorials/fused_mamba>` tutorial for a concrete example to
combine matrix-vector multiplication and exponential evaluation in a single ``nisa.activation`` instruction. Similarly,
in :doc:`Fused Self Attention </nki/tutorials/fused-self-attn>` tutorial, we combine the subtraction of the maximum with exponential
...
of different ISA instructions. Refer to the :doc:`architecture guide </nki/about/trainium_inferentia2_arch>`
for layout requirements of each compute engine. Transposes are inserted explicitly into NKI kernels through
:doc:`nl.transpose </nki/api/generated/nki.language.transpose>` or :doc:`nisa.sb_transpose </nki/api/generated/nki.isa.nc_transpose>`
