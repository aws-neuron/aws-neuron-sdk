.. _setup-tensorflow-neuron-al2023:
...
TensorFlow Neuron ("tensorflow-neuron") Setup on Amazon Linux 2023
===================================================================
...
.. dropdown::  Install Drivers and Tools
    ...
    .. program-output:: python3 src/helperscripts/n2-helper.py --install-type=install --framework=pytorch --framework-version=1.13.1 --file=src/helperscripts/n2-manifest.json --os=amazonlinux2023 --instance=inf1 --ami=non-dlami --category=driver_runtime_tools


.. include:: /about-neuron/quick-start/tab-inference-tensorflow-neuron-al2023.txt
