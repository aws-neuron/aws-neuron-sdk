.. _install-neuronx-2.3.0-pytorch:
...
.. tab-set::
   ...
   .. tab-item:: PyTorch 1.11.0
      ...
      .. tab-set::
		...
		python -m pip install torch-neuronx=="1.11.0.1.1.1" "neuronx-cc==2.1.0.76" transformers
		...
		sudo yum install aws-neuronx-dkms-2.5.41.0  -y
		sudo yum install aws-neuronx-oci-hook-2.0.16.0  -y
		...
		sudo yum install aws-neuronx-tools-2.4.14.0  -y
