...
.. meta::
   :noindex:
   :nofollow:
   :description: Archived getting-started guide for the Neuron plugin for TensorBoard on Trn1. End of support in Neuron 2.29. Use Neuron Explorer instead.
   :date-modified: 2026-05-11

NeuronX Plugin for TensorBoard (Trn1) (archived)
=================================================

.. warning::

   This document is archived. The Neuron plugin for TensorBoard on Trn1
   reached end of support. It is provided for reference only and is no
   longer maintained.

   Use :ref:`Neuron Explorer <neuron-explorer-home>` for current profiling,
   analysis, and optimization workflows. See the :ref:`Neuron Explorer FAQ
