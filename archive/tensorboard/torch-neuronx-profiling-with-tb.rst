...
.. meta::
   :noindex:
   :nofollow:
   :description: Archived tutorial for profiling PyTorch NeuronX (torch-neuronx) with TensorBoard. End of support in Neuron 2.29. Use Neuron Explorer instead.
   :date-modified: 2026-05-11

Profiling PyTorch NeuronX with TensorBoard (archived)
======================================================
