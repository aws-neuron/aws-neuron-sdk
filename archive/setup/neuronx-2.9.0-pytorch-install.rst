...
Install PyTorch NeuronX (Neuron 2.9.0) — Archived
=================================================

.. warning::

   This document is archived. Neuron 2.9.0 is a superseded release provided
        ...
        .. tab-set::
            ...
            .. tab-item:: Amazon Linux 2 AMI
                ...
                .. code-block:: bash
                    ...
                    python -m pip install neuronx-cc==2.5.0.28 torch-neuronx==1.13.0.1.6.0
