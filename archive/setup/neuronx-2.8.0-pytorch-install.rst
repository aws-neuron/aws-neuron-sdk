...
Install PyTorch NeuronX (Neuron 2.8.0) — Archived
=================================================

.. warning::

   This document is archived. Neuron 2.8.0 is a superseded release provided
        ...
        .. tab-set::
            ...
            .. tab-item:: Amazon Linux 2 AMI
                ...
                .. code-block:: bash
                    ...
                    python -m pip install neuronx-cc==2.4.0.21 torch-neuronx==1.13.0.1.5.0
