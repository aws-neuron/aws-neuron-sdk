...
* [:download:`Download example YAML file </deploy/files/specs/1x4-connected-devices.yaml>`]
...
.. image:: /deploy/images/neuron-dra-connected-devices.jpeg
...
* [:download:`Download example YAML file </deploy/files/specs/lnc-setting-trn2.yaml>`]
...
* [:download:`Download example YAML file </deploy/files/specs/4-node-inference-us.yaml>`]
...
.. toctree::
   ...
   Support Files </deploy/files/index-dra>
