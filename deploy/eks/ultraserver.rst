...
Neuron UltraServers (``Trn2`` and ``Trn3``) represent a sophisticated computing infrastructure designed to connect multiple
Trainium instances through NeuronLink. For many advanced and complex models, customers can use UltraServers to greatly
reduce training and inference times compared to previous distributed job setups.
...
* Write a new hostfile to ``/ultraserver_init/new_hostfile``
...
* An EKS cluster with Trn2 or Trn3 UltraServers (:ref:`tutorial-k8s-env-setup-for-neuron`)
* Neuron Device Plugin installed on the cluster with version >= 2.30.0.0 (:ref:`deploy-eks`)
...
- :ref:`tutorial-k8s-env-setup-for-neuron` - Information about how to use Neuron on EKS
- :ref:`deploy-eks` - Information about Neuron Device Plugin
- :ref:`aws-trn2-arch` - Information about Trn2 UltraServer architecture
- :ref:`aws-trn3-arch` - Information about Trn3 UltraServer architecture
