.. meta::
   :description: Third-party solutions and partner integrations for deploying Neuron workloads on AWS Trainium and Inferentia.
   :keywords: Neuron, third-party, Ray, Domino, partner, integrations, Trainium, Inferentia
...
AWS Neuron integrates with multiple third-party partner solutions that allow you to run deep learning workloads on Amazon EC2
...
any scale. Ray simplifies the complexity of distributed computing, improves efficiency, lowers costs, and accelerates developer
productivity.
